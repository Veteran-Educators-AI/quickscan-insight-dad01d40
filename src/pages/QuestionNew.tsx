...
const GEOMETRY_JMAP_TOPICS = [
  {
    ...
    topics: [
      ...
      { name: 'Surface Area', standard: 'G.GMD.A.3', url: 'https://www.jmap.org/htmlstandard/G.GMD.A.3.htm' },
      { name: 'Surface Area of Prisms and Cylinders', standard: 'G.GMD.A.3', url: 'https://www.jmap.org/htmlstandard/G.GMD.A.3.htm' },
      { name: 'Surface Area of Pyramids and Cones', standard: 'G.GMD.A.3', url: 'https://www.jmap.org/htmlstandard/G.GMD.A.3.htm' },
      { name: 'Surface Area of Spheres', standard: 'G.GMD.A.3', url: 'https://www.jmap.org/htmlstandard/G.GMD.A.3.htm' },
